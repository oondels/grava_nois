...
async function install() {
  ...
  try {
    ...
    if (choice.outcome === 'accepted') {
      ...
      // usuário fechou o prompt do navegador
      dismiss()
    }
  } catch {
    // falha ao exibir ou interagir; mantém opção para tentar novamente
  }
}
...
.btn { cursor: pointer; padding: 6px 10px; border-radius: 8px; border: 1px solid rgba(255,255,255,.12); background: transparent; color: #fff; }
